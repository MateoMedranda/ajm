...
const services = [
  {
    ...
    description:
      "Página de aterrizaje profesional optimizada para conversión. Perfecta para lanzar tu producto, servicio o campaña con máximo impacto visual.",
    image: tabletCodeImg,
    features: [
      "Diseño Responsivo",
      "SEO Optimizado",
  ...
  },
  {
    ...
    description:
      "Sitio web completo con múltiples secciones, blog integrado y panel de administración. Ideal para empresas que buscan una presencia sólida online.",
    image: tabletCodeImg,
    features: [
      "Multi-página",
      "CMS Integrado",
  ...
  },
  {
    ...
    description:
      "Sistema web avanzado con arquitectura escalable, base de datos, autenticación de usuarios y funcionalidades personalizadas para tu negocio.",
    image: tabletCodeImg,
    features: [
...
const Services = ({ id }: { id?: string }) => {
  ...
  return (
    <section id={id} className="relative py-32 px-4 bg-white">
      {/* Curved top */}
      <div className="absolute top-0 left-0 right-0 overflow-hidden leading-none"></div>
