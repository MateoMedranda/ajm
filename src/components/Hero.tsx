    ...
    <section id={id} className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          ...
          // Ajusta la opacidad (ej. opacity-30) si las luces originales se pierden mucho
      ...
      {/* --- CAPA 2: LUCES ORIGINALES RESTAURADAS --- */}
      {/* Estas son las luces exactas de tu primer código */}
